 ...
 * Prologue Header: 가용 블록의 시작을 나타내는 헤더 (값 = 8, 할당 상태 = 1)
 * Prologue Footer: 가용 블록의 끝을 나타내는 풋터 (값 = 8, 할당 상태 = 1)
 * Epilogue Header: 힙의 끝을 나타내는 헤더 (값 = 0, 할당 상태 = 1)
 *
 * 
 * 블록 구조
...
/* 힙 메모리 할당 정책 */
// #define FIRST_FIT // 44 + 13 = 58
// #define BEST_FIT // 45 + 13 = 58
#define NEXT_FIT // 43 + 40 = 83
